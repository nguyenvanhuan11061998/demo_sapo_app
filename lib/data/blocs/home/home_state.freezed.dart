...
class _$HomeStateTearOff {
  ...
  HomeStateData call(List<ProductModel> products) {
...
class _$HomeStateData implements HomeStateData {
  const _$HomeStateData(this.products);
...
abstract class HomeStateData implements HomeState {
  const factory HomeStateData(List<ProductModel> products) = _$HomeStateData;
